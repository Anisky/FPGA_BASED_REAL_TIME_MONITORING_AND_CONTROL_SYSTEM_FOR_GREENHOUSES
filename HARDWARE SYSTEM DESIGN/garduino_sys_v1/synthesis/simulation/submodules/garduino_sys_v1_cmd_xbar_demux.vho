...
--synthesis_resources = 
 ...
 ENTITY  garduino_sys_v1_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END garduino_sys_v1_cmd_xbar_demux;

 ARCHITECTURE RTL OF garduino_sys_v1_cmd_xbar_demux IS
 ...
 END RTL; --garduino_sys_v1_cmd_xbar_demux
