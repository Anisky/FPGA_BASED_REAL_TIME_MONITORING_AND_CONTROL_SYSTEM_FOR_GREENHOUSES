...
--synthesis_resources = 
 ...
 ENTITY  garduino_sys_v1_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src10_data	:	OUT  STD_LOGIC_VECTOR (99 DOWNTO 0);
		 ...
		 src11_data	:	OUT  STD_LOGIC_VECTOR (99 DOWNTO 0);
		 ...
		 src12_data	:	OUT  STD_LOGIC_VECTOR (99 DOWNTO 0);
 ...
 END garduino_sys_v1_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF garduino_sys_v1_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_garduino_sys_v1_cmd_xbar_demux_001_wideor0_27_dataout :	STD_LOGIC;
 ...
 END RTL; --garduino_sys_v1_cmd_xbar_demux_001
