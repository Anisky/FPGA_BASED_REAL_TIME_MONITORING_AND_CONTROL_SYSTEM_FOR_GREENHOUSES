...
--synthesis_resources = 
 ...
 ENTITY  garduino_sys_v1_rsp_xbar_demux_003 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END garduino_sys_v1_rsp_xbar_demux_003;

 ARCHITECTURE RTL OF garduino_sys_v1_rsp_xbar_demux_003 IS
 ...
 END RTL; --garduino_sys_v1_rsp_xbar_demux_003
