...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_agent.sv"                                                                  -work sys_cpu_v1_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                           -work sys_cpu_v1_jtag_debug_module_translator_avalon_universal_slave_0_agent         
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_agent.sv"                                                                 -work sys_cpu_v1_instruction_master_translator_avalon_universal_master_0_agent       
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_slave_translator.sv"                                                             -work sys_cpu_v1_jtag_debug_module_translator                                        
  vlog  "$QSYS_SIMDIR/submodules/aldec/altera_merlin_master_translator.sv"                                                            -work sys_cpu_v1_instruction_master_translator                                       
...
alias elab_debug {
  ...
  vsim -dbg -O2 +access +r -t ps -L work -L irq_mapper -L width_adapter -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_003 -L rsp_xbar_demux -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L burst_adapter -L id_router_003 -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rdata_fifo -L sdram_controller_s1_translator_avalon_universal_slave_0_agent_rsp_fifo -L sys_cpu_v1_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L sys_cpu_v1_jtag_debug_module_translator_avalon_universal_slave_0_agent -L sys_cpu_v1_instruction_master_translator_avalon_universal_master_0_agent -L sys_cpu_v1_jtag_debug_module_translator -L sys_cpu_v1_instruction_master_translator -L Curtains -L Roof -L Lights -L soil_rain_solar_data -L tem_and_humidity_data -L sysid -L bluetooth_uart -L jtag_uart -L sdram_controller -L onchip_memory2 -L sys_clk -L sys_cpu_v1 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cycloneii $TOP_LEVEL_NAME
}
